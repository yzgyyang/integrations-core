...
from .common import _get_expected_tags, _get_expected_replication_tags, DB_NAME, HOST, PORT, PORT_REPLICA2, POSTGRES_VERSION
...
def test_failed_explain_handling(
    ...
    expected_tags=_get_expected_tags(None, dbm_instance, with_db=True,
                            agent_hostname='stubbed.hostname') + [expected_error_tag]
...
def test_load_pg_settings(aggregator, integration_check, dbm_instance, db_user):
    ...
    if db_user == 'datadog_no_catalog':
        aggregator.assert_metric(
            "dd.postgres.error",
            tags=_get_expected_tags(check, dbm_instance, role=None, with_db=True,
...
def test_statement_metrics_database_errors(
    ...
    expected_tags = _get_expected_tags(None, dbm_instance, with_db=True, agent_hostname='stubbed.hostname') + [expected_error_tag]
